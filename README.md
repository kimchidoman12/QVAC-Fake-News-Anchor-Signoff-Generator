# QVAC Fake News Anchor Signoff Generator

Type tonight's top story topic and an on-device AI writes a local news anchor's closing signoff line for it, with a deterministic charm meter.
...
Then open http://localhost:29428
